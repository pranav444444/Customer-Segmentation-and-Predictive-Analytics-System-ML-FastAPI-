...
1. We have used xgboost classifier for the project as in notebooks we can clearly see that it os giving higher accuracy amongst other algorithms. Now you have to use any other algorithm and that should be performing better than logistic regression. You can use hyperparameter tuning to tune the models and use that model in this project.
